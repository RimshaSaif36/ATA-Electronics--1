...
export default function ATAStorySection() {
  return (
    <section className="text-white min-h-screen flex items-center justify-center py-12 px-6 overflow-hidden relative">

      
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">

        {/* Image Area - Improved Layout */}
        <div className="relative w-full  h-125 flex items-center justify-center overflow-invisible">
          ...
          <Motion.div
            ...
            viewport={{ once: false, amount: 0.3 }}
            transition={{ duration: 0.8 }}
            className="relative z-10 w-64 h-80 md:w-120 md:h-84  overflow-hidden border border-[#d4af37]/30 shadow-2xl shadow-[#d4af37]/15"
          >
            <img 
              src="/light2.jpg" 
              alt="Main Feature" 
          ...
          <Motion.div
            ...
            viewport={{ once: false, amount: 0.3 }}
            transition={{ duration: 0.8, delay: 0.2 }}
            className="absolute top-10 left-4 md:left-10 w-44 h-36 md:w-60 md:h-40  overflow-hidden border border-[#d4af37]/30 shadow-lg z-0 shadow-[#d4af37]/15"
          >
            <img 
              src="/light.jpg" 
              alt="Light Feature" 
          ...
          <Motion.div
            ...
            viewport={{ once: false, amount: 0.3 }}
            transition={{ duration: 0.8, delay: 0.2 }}
            className="absolute bottom-10 right-4 md:right-10 w-44 h-36 md:w-60 md:h-40 overflow-hidden border border-[#d4af37]/30 shadow-lg z-20 shadow-[#d4af37]/15"
          >
            <img 
              src="/light3.jpg" 
              alt="Solar Feature" 
