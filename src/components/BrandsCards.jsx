...
export default function BrandsCards() { 
  ...
  return ( 
    <section className="relative min-h-[140vh] lg:min-h-screen flex flex-col lg:flex-row items-center justify-center overflow-hidden px-4 md:px-8 py-12 gap-4 lg:gap-0"> 
