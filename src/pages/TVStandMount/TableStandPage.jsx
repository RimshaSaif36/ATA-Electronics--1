...
const products = [
  {
    ...
    spec: "Fits 32 - 65 inch TVs, Desktop Use",
    type: "TABLE TOP TV STAND",
    img: "/TableStand.jpg",
  },
  {
    title: "ADJUSTABLE TABLE STAND",
    spec: "Fits 26 - 55 inch TVs, Height Adjustable",
    type: "ADJUSTABLE TABLE STAND",
    img: "/TableStand.jpg",
  },
  {
    title: "SWIVEL TABLE STAND",
    spec: "Fits 32 - 60 inch TVs, 180° Swivel",
    type: "SWIVEL TABLE STAND",
    img: "/TableStand.jpg",
  },
  {
    title: "UNIVERSAL TABLE STAND",
    spec: "Fits Most 22 - 55 inch TVs",
    type: "UNIVERSAL TABLE STAND",
    img: "/TableStand.jpg",
  },
];

export default function TableStandPage() {
      ...
      <section className="bg-white">
        <div className="relative overflow-hidden bg-gradient-to-r from-red-800 via-red-700 to-red-900">
          <div className="max-w-6xl mx-auto px-6 py-10 text-white">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold">TABLE STAND</h1>
          </div>
        </div>
      </section>
