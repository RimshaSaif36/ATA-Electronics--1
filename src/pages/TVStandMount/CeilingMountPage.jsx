...
const products = [
  ...
  },
  {
    ...
    spec: "Fits 26 - 60 inch TVs, Tilt Adjustable",
    type: "TILT CEILING MOUNT",
    img: "/CeilingMount.jpg",
  },
];

export default function CeilingMountPage() {
      ...
      <section className="bg-white">
        <div className="relative overflow-hidden bg-gradient-to-r from-red-800 via-red-700 to-red-900">
          <div className="max-w-6xl mx-auto px-6 py-10 text-white">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold">CEILING MOUNT</h1>
          </div>
        </div>
      </section>
