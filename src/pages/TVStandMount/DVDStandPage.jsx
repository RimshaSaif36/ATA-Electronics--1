...
const products = [
  {
    title: "DVD STAND",
    spec: "Universal Fit, Strong Metal Base",
    type: "DVD STAND",
    img: "/DVDStand.jpg",
  },
  {
    title: "ADJUSTABLE DVD STAND",
    spec: "Height Adjustable, Universal Fit",
    type: "ADJUSTABLE DVD STAND",
    img: "/DVDStand.jpg",
  },
  {
    title: "DVD STAND WITH SHELF",
    spec: "Extra Storage Shelf, Strong Base",
    type: "DVD STAND WITH SHELF",
    img: "/DVDStand.jpg",
  },
  {
    title: "SLIM DVD STAND",
    spec: "Slim Design, Space Saving",
    type: "SLIM DVD STAND",
    img: "/DVDStand.jpg",
  },
];

export default function DVDStandPage() {
      ...
      <section className="bg-white">
        <div className="relative overflow-hidden bg-gradient-to-r from-red-800 via-red-700 to-red-900">
          <div className="max-w-6xl mx-auto px-6 py-10 text-white">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold">DVD STAND</h1>
          </div>
        </div>
      </section>
